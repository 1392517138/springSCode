...
public class AnnotationConfigUtils {
	...
	public static void registerAnnotationConfigProcessors(BeanDefinitionRegistry registry) {
		//这里不明白，该处返回的是void，但下面的这个registerAnnotationConfigProcessors返回的Set<BeanDefinitionHolder>
	...
	public static Set<BeanDefinitionHolder> registerAnnotationConfigProcessors(
		...
		//得到GenericApplicationContext初始化时后的DefaultListableBeanFactory
		...
		//beanDefinition与beanName,  aliases【不重要】
		Set<BeanDefinitionHolder> beanDefs = new LinkedHashSet<>(8);
		//BeanDefinitio的注册，这里很重要，需要理解注册每个bean的类型
		//判断DefaultListableBeanFactory是否含有xx
		if (!registry.containsBeanDefinition(CONFIGURATION_ANNOTATION_PROCESSOR_BEAN_NAME)) {
			...
			//可以理解为RootBeanDefinition用来描述spring内部的类
			RootBeanDefinition def = new RootBeanDefinition(ConfigurationClassPostProcessor.class);
			//source本来传进来就为空
			def.setSource(source);
			//通过registerPostProcessor先往DefaultListableBeanFactory中的一个map添加，再返回一个BeanDefinitionHolder
	...
	private static BeanDefinitionHolder registerPostProcessor(
		...
		//放进DefaultListableBeanFactory 中的 Map<String, BeanDefinition> beanDefinitionMap
